<?php
    // Small plugin to allow custom post type archives to be added to nav menues
    ...
    class Custom_Post_Type_Archive_Menu_Links {
      ...
      static function inject_cpt_archives_menu_meta_box() {
        add_meta_box( 'add-cpt', __( 'Archives', 'default' ), array(__CLASS__,'wp_nav_menu_cpt_archives_meta_box'), 'nav-menus', 'side', 'default' );
      }

      /* render custom post type archives meta box */
      static function wp_nav_menu_cpt_archives_meta_box() {
      ...
      static function cpt_archive_menu_filter( $items, $menu, $args ) {
